...
is_equal(F1, F2, Precision) when F1 == F2 -> true;
is_equal(F1, F2, Precision) when F1 < 0, F2 < 0, ((F1 ) - (F2)) =< Precision -> true;
% is_equal(F1, F2, Precision) when F1 < 0, F2 < 0, ((F1 * (-1)) - (F2 * (-1))) =< Precision -> true; 
is_equal(F1, F2, Precision) when F1 > 0, F2 > 0, F1 > F2, F1 - F2 =< Precision -> true;
